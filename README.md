...
Этот скрипт автоматизирует процесс установки и базовой настройки утилиты zapret от bol-van для пользователей Alt Linux для работы со списком хостов. Скрипт берет последнюю версию с гитхаба автора, а не использует пакет в репозитории AltLinux.
...
- **Необходимо sudo:** control sudowheel enabled
- **Устанавливает зависимости:** gcc-c++ make libmnl-devel zlib-devel libcap-devel libnetfilter_queue-devel libnfnetlink-devel nftables iptables ipset bind curl git unzip systemd-devel.
- **Установка zapret:** Установка zapret из git.
